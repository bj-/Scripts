...
begin
 ...
 @lbl    NVARCHAR(20) = 'LabelWarning%' ,    -- маска типа сообщения: 'GaugeBattery', 'LabelWarning', 'LabelDriver', 'LabelPosition', 'LabelRoute'
 @fio    NVARCHAR(80) = '%%' ,               -- маска ФИО        
 @text   NVARCHAR(20) = '%%',                -- маска текста сообщения
 @mindate DATE = '2016-01-01',               -- дата От включительно
 @maxdate DATE = '2020-12-31';               -- дата По включительно 
 
SELECT  
  CAST(j.Started AS DATE) per_day
  ,s.serialno server
