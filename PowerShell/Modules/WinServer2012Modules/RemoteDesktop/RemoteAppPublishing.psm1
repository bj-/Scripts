...
param (
    ...
    {
        $root = [System.IO.Path]::GetFileNameWithoutExtension($appProperties["AppPath"])
...
param (
    ...
    if([System.String]::IsNullOrEmpty($appProperties["VirtualPath"]))
    {
        # The workflow requires a string with one space in it to represent an empty virtual path
        $appProperties["VirtualPath"] = " "
    }
