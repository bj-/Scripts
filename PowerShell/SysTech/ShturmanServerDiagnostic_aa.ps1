...
#                                "Shturman3"# имя БД
	[string]$SQLServerUserName = "ShturmanOperator", # пользователь БД
	[string]$SQLServerUserPass = "P@ssw0rd", # Пароль пользоателя БД
...
#                                ("Root4","SupRoot","Root3","Anal")
	...
	[array]$ServiceNameExe = ("HttpsServer", "BOINormsServer","DataStorageServer","DataProcServer","DiagServer","FOSServer","HubServer","LogServer","LogServer3","MetroLocationsServer","RRsServer","UpdateServer","FresherServer","SolverServer","DataTransferServer", "ShturmanHub", "ShturmanData", "ShturmanLogic", "ShturmanMath", "ShturmanTransfer", "ShturmanFresher"),
    [array]$ServiceNameLog = ("Https", "BOINorms","Data","DataProc","Diag","FOS","Hub","Log","Log","Location","RRs","Update","Fresher","Solver","DataTransfer", "ShturmanHub", "ShturmanData", "ShturmanLogic", "ShturmanMath", "ShturmanTransfer", "ShturmanFresher"), #  имя используемое джля формирование лог файлов
